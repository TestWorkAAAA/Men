    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            requestFrom:function(e){
                ...
                if( ( (Date.parse(new Date (startTime) )/1000) !=null )&&( (Date.parse(new Date (endtime) )/1000)!=null )&&( (Date.parse(new Date (startTime) )/1000) > (Date.parse(new Date (endtime) )/1000) )){
                   ...
                   this.err = "开始时间应该小于结束时间,否则没办法筛选！";
                    ...
                    this.$http.get("/MySchool-web/request/getRequestInfoList?page=1", formData)
                    .then(function(res){
            ...
            methodFrom:function(){
                ...
                this.$http.get("/MySchool-web/method/getMethodInfoList?page=1",formData )
                    .then(function(res){
                        var arr=res.data;  // 返回obj
            ...
            getPageData:function(n){
                ...
                if( n== undefined||n==null){
                    ...
                    this.$http.get("/MySchool-web/request/getRequestInfoList?page="+n,FormData)
                    .then(function(res){
                        var arr = res.data;  // 返回obj
                        if(arr.code==0) {
                            this.count = arr.count;
            ...
            getPageData2:function(n){
                ...
                if(n==undefined||n==null){
                    ...
                    this.$http.get("/MySchool-web/method/getMethodInfoList?page="+n,FormData).then(function(res){
                        var arr=res.data;  // 返回obj
                        if(arr.code==0){
                            this.count2 = arr.count;
                            this.page2 = n;// 跳转到第几页
